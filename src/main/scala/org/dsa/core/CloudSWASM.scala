...
/**
  ...
  */
class CloudSWASM extends DSASSequenceAlignmentTime {
...
object CloudSWASM {
  ...
  def saveResult(str: String): Unit = {
    val conf = new SparkConf().setAppName("DSW2SASM" + " Application:saveResult,out:" + outStr)
    // initialize SparkContext
